...
EXIT_POLICIES = {
    ...
    "B_ATR_2_4": {"type": "ATR_TARGET", "stop_atr": 2.0, "target_atr": 4.0, "max_days": 10},
    "C_ATR_2_4_10D": {"type": "HYBRID", "stop_atr": 2.0, "target_atr": 4.0, "max_days": 10},
}
...
def main():
    ...
    print("EXITS: A=10D | B=ATR 2x/4x | C=ATR 2x/4x + MAX10D")
